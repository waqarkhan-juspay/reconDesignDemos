...
import { newFieldColumn, type FieldsAnswers } from './answers'
  ...
  return (
    ...
    >
          ...
          {columns.map((column, index) => {
            ...
            return (
              <div
                ...
                style={{ width: COLUMN_WIDTH, opacity: dragIndex === index ? 0.4 : 1 }}
                onDragOver={(event) => {
              ...
              >
                ...
                >
                  ...
                  />
                  {/* The last column is not deletable — a report with no columns is not a
                      state the rest of the flow can do anything with. */}
                  {columns.length > 1 && (
                    <button
                      type="button"
                ...
                >
                  ...
                  <div style={{ height: 1, width: 140, backgroundColor: colors.gray[200] }} />
                </div>
              </div>
            )
          })}
      ...
      <ButtonV2
        ...
        onClick={() => setColumns([...columns, newFieldColumn()])}
      />
    </div>
  )
}
